\section{Néhány hasznos beépített osztály(sablon)}

\subsection{A \texttt{string} osztály}

\begin{frame}
    Az \hiv{\href{https://en.cppreference.com/w/cpp/string/basic_string}{\texttt{std::string}}} osztály néhány érdekes tulajdonsága:
    \begin{itemize}
...
\begin{frame}
    A \hiv{\href{https://en.cppreference.com/w/cpp/container/vector}{\texttt{vector}}} osztály
    \begin{itemize}
...
\begin{frame}
    A \hiv{\href{https://en.cppreference.com/w/cpp/container/deque}{\texttt{deque}}} osztály
    \begin{itemize}
...
\begin{frame}
    A \hiv{\href{https://en.cppreference.com/w/cpp/container/list}{\texttt{list}}} osztály
    \begin{itemize}
...
\begin{frame}
    A \hiv{\href{https://en.cppreference.com/w/cpp/container/set}{\texttt{set}}} osztály
    \begin{itemize}
        \item Fejfájl: \texttt{<set>}
        \item Rendezett halmaz, ismétlődés nem megengedett.
        \item Keresés, beszúrás, eltávolítás: $\mathcal{O}(\log{}n)$ komplexitás $\to$ többnyire \hiv{\href{https://hu.wikipedia.org/wiki/Piros-fekete\_fa}{piros-fekete fával}} megvalósítva.
        \item Tartalma megváltoztatható (mutable).
    \end{itemize}
\end{frame}
...
\begin{frame}
    \begin{exampleblock}{\textattachfile{setDemo.cpp}{setDemo.cpp}}
        \small
        \lstinputlisting[language=C++,style=C++,linerange={1-10},numbers=left,firstnumber=1]{setDemo.cpp}
    \end{exampleblock}
\end{frame}
...
\begin{frame}
    \begin{exampleblock}{\textattachfile{setDemo.cpp}{setDemo.cpp}}
        \footnotesize
        \lstinputlisting[language=C++,style=C++,linerange={12-21},numbers=left,firstnumber=12]{setDemo.cpp}
    \end{exampleblock}
\end{frame}
...
\begin{frame}
    ...
    \begin{exampleblock}{\textattachfile{setDemo.cpp}{setDemo.cpp}}
        \footnotesize
        \vspace{-.2cm}
        \lstinputlisting[language=C++,style=C++,linerange={23-38},numbers=left,firstnumber=23]{setDemo.cpp}
        \vspace{-.2cm}
    \end{exampleblock}
\end{frame}
...
\begin{frame}[fragile]
    \begin{exampleblock}{\textattachfile{setDemo.cpp}{setDemo.cpp}}
        \footnotesize
        \lstinputlisting[language=C++,style=C++,linerange={40-42},numbers=left,firstnumber=40]{setDemo.cpp}
    \end{exampleblock}
    \begin{block}{Kimenet}
        \vspace{-.3cm}
        \begin{verbatim}
Even numbers: 0 2 4 6 8 10 
Numbers divisible by three: 0 3 6 9 
Numbers divisable by six: 0 6
        \end{verbatim}
        \vspace{-.5cm}
    \end{block}
\end{frame}
...
\begin{frame}
    A \hiv{\href{https://en.cppreference.com/w/cpp/container/map}{\texttt{map}}} osztály
    \begin{itemize}
